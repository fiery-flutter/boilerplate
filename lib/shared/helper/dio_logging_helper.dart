...
class DioLoggingInterceptors extends InterceptorsWrapper {
  ...
  Future onRequest(RequestOptions options) async {
    ...
    if (options.headers.containsKey('requirestoken')) {
      ...
      print(
          'accessToken: ${_cacheHelper.getString(CacheHelper.ACCESS_TOKEN_KEY)}');
      String accessToken = _cacheHelper.getString(CacheHelper.ACCESS_TOKEN_KEY);
  ...
  Future onError(DioError dioError) async {
    ...
    String oldAccessToken =
        _cacheHelper.getString(CacheHelper.ACCESS_TOKEN_KEY);
